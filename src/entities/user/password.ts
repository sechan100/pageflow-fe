...
import { FieldError, ServerFieldValidationResult } from "@/shared/field";
...
export const changePasswordRequest = async ({ currentPassword, newPassword }: Form): Promise<ChangePasswordResult> => {
  const data = {
    currentPassword,
    newPassword
  }
